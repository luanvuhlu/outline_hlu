# -*- coding: utf-8 -*-
# Generated by Django 1.9.7 on 2016-07-10 15:42
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('account', '0005_auto_20160710_1542'),
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('create_time', models.DateTimeField(auto_now_add=True, verbose_name='Th\u1eddi gian t\u1ea1o')),
                ('update_time', models.DateTimeField(blank=True, verbose_name='Th\u1eddi gian c\u1eadp nh\u1eadt')),
                ('address_1', models.CharField(blank=True, max_length=100, verbose_name='\u0110\u1ecba ch\u1ec9')),
                ('name', models.CharField(max_length=255, verbose_name='T\xean')),
                ('name_abbr', models.CharField(blank=True, max_length=255, verbose_name='T\xean vi\u1ebft t\u1eaft')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('specialized_study', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, to='university.SpecializedStudy')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('create_time', models.DateTimeField(auto_now_add=True, verbose_name='Th\u1eddi gian t\u1ea1o')),
                ('update_time', models.DateTimeField(blank=True, verbose_name='Th\u1eddi gian c\u1eadp nh\u1eadt')),
                ('founding', models.DateTimeField(verbose_name='Ng\xe0y th\xe0nh l\u1eadp')),
        ...
        migrations.AddField(
            model_name='student',
            name='u_class',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='university.UClass'),
        ),
        migrations.AddField(
